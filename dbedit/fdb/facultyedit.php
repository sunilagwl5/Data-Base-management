...
if (mysqli_connect_errno())
  ...
  session_start();
  if(!((isset($_SESSION['username']) || isset($_SESSION['activfac'])) ))
  {
	...
	{
		$result = mysqli_query($con,"SELECT * FROM member m,faculty s 
  WHERE m.user_id=s.faculty_id and m.user_id='$_SESSION[username]'");
...
<title>Faculty Database Edit</title>
...
<h1 style="text-decoration: underline">Edit Faculty Database</h1>
<br>
<br>
<form action="submitfaculty.php" id="student" class="validate" method="post">
  <fieldset>
  <div class="field">
  ...
  <div class="field">
      ...
      <input type="text" name="Employee_Id" id="Employee_Id" class="required" value="<?php echo $row['emp_id']?>"/>
    </div>
	<div class="field">
      <label for="username">Course Undertaken.</label>
      <input type="text" name="course" id="course" class="required" value="<?php echo $row['course']?>"/>
    </div>
    <div class="field">
