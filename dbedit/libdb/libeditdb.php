...
if (mysqli_connect_errno())
  ...
  if(!((isset($_SESSION['username']) || isset($_SESSION['activstu'])) ))
  {
  	...
  	die('You must login First');
		...
		$result = mysqli_query($con,"SELECT * FROM member m,librarian s 
  WHERE m.user_id=s.user_id and m.user_id='$_SESSION[username]'");
...
<title>Librarian Database Edit</title>
...
<h1 style="text-decoration: underline">Edit Librarian Database</h1>
<br>
<br>
<form action="submitlib.php" id="student" class="validate" method="post">
  <fieldset>
  <div class="field">
